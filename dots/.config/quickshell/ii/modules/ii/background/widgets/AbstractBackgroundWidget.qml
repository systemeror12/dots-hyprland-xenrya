...
AbstractWidget {
    ...
    property bool wallpaperIsVideo: Config.options.background.wallpaperPath.toLowerCase().endsWith(".mp4") || Config.options.background.wallpaperPath.toLowerCase().endsWith(".webm") || Config.options.background.wallpaperPath.toLowerCase().endsWith(".mkv") || Config.options.background.wallpaperPath.toLowerCase().endsWith(".avi") || Config.options.background.wallpaperPath.toLowerCase().endsWith(".mov")
